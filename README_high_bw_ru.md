...
Простой способ создать отказоустойчивое распределенное хранилище на базе GlusterFS.
...
> !!! Установите количество хранилищ по умолчанию на 30 и увеличьте ресурсы (CPU/RAM) в переменных.
...
### Бенчмаркинг для настройки производительности
