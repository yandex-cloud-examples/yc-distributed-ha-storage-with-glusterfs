...
В этом руководстве описано, как создать отказоустойчивое распределенное хранилище на базе GlusterFS.
...
1. Отключите узел хранения в зоне (если в зоне только один узел).
